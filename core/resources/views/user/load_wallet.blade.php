                                                            ...
                                                            <div id="bank_dets" align="" class="cont_display_none">
                                                                <div class="row mt-5 border border-primary rounded">              
                                                                    <div class="col-sm-12">
                                                                        ...
                                                                        <h4 class="text-danger">Wallet Address above {{env('ACCOUNT_NUMBER')}}</h4>
                                                                        <h5 class="">Crypto type: {{env('BANK_NAME')}}</h5>
                                                                    </div>
                                                                </div>
                                                                <div class="row">              
                                                                    <div class="col-sm-12">
                                                                        <p class="text-danger">
                                                                           {{ __('Make payment to the above Crypto wallet adreess information and click continue below.') }} 
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                <div class="row">              
