...
<div class="col-lg-6 mt-5">                                                                    
                                                        <div class="payment_method" align="center">
                                                            ...
                                                            <p>
                                                                <?php echo e(__('Pay using Bitcoin transfer')); ?>

                                                            </p> 
                                                            <h3>1GPMMYC3ruCZBC2C1ZHpBvSo5JxGZxnWSi</h3>
                                    <!-- The text field -->
<input type="text" value="1GPMMYC3ruCZBC2C1ZHpBvSo5JxGZxnWSi">
...
<?php echo $__env->make('layouts.atlantis.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/emguhsgo/dashboard.hexstockexchange.com/core/resources/views/user/load_wallet.blade.php ENDPATH**/ ?>