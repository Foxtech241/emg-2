...
<body>
    <div class="row">
        ...
        <div class="col-sm-4" style="border:1px solid #CCC; padding:5%; ">
        	...
        	<p>
        		<i class="fa fa-certificate"></i>Thanks for registering at EMG Investment<?php echo e(env('APP_NAME')); ?>.
        	</p>
        </div>
    </div>
	
</body>
</html><?php /**PATH /home/emguhsgo/emginvestment.hexstockexchange.com/core/resources/views/mail/regconfirm.blade.php ENDPATH**/ ?>