                                                ...
                                                <div id="pay_cont" class="row">
                                                    ...
                                                    <div class="col-lg-6 mt-5">                                                                    
                                                        <div class="payment_method" align="center">
                                                            ...
                                                            <p>
                                                                <?php echo e(__('Pay using Bitcoin')); ?>

                                                            </p> 
                                                           
                                                            <div align="">
                                                                <a id="pay_with_bank_dep" href="javascript:void(0)" class="btn btn_blue" >
                                                                    <?php echo e(__('Deposit with Crypto')); ?>
                                                            ...
                                                            <div id="bank_dets" align="" class="cont_display_none">
                                                                <div class="row mt-5 border border-primary rounded">              
                                                                    <div class="col-sm-12">
                                                                        ...
                                                                        <h4 class="text-danger">Wallet Address above <?php echo e(env('ACCOUNT_NUMBER')); ?></h4>
                                                                        <h5 class="">Crypto type: <?php echo e(env('BANK_NAME')); ?></h5>
                                                                    </div>
                                                                </div>
                                                                <div class="row">              
                                                                    <div class="col-sm-12">
                                                                        <p class="text-danger">
                                                                           <?php echo e(__('Make payment to the above Crypto wallet adreess information and click continue below.')); ?> 
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                <div class="row">              
                        ...
                        <form action="/user/wallet/bank_deposit" method="post">
                            ...
                            <div class="form-group">
                              <div class="input-group" >                   
                                ...
                                <input type="text" class="form-control" name="account_name"  required placeholder="Wallet name sent from" >
                              </div>
                            </div>
                            <div class="form-group">
                              <div class="input-group" >                   
                                ...
                                <input type="text" class="form-control" name="account_no"  required placeholder="Wallet Address sent From" >
                              </div>
                            </div>
                            <div class="form-group">
                              <div class="input-group" >                   
                                ...
                                <input type="text" class="form-control" name="bank_name"  required placeholder="Bitcoin Platform Sent from" >
                              </div>
                            </div>
                            <div class="form-group">
                              <br>
...
<?php echo $__env->make('layouts.atlantis.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/emguhsgo/emginvestment.hexstockexchange.com/core/resources/views/user/load_wallet.blade.php ENDPATH**/ ?>